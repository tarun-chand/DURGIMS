...
if (jQuery("#editor").length) {
  ...
  if (jQuery("#report-pichart").length) {  
    ...
    labels: ['Total Product Count', 'Total Product InHand', 'Total Product Issued '],
    responsive: [{
      breakpoint: 480,
      options: {
        chart: {
    ...
    (chart = new ApexCharts(document.querySelector("#report-pichart"), options)).render()
    const body = document.querySelector('body')
    if (body.classList.contains('dark')) {
      apexChartUpdate(chart, {
        dark: true
